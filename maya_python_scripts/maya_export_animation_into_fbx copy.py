...
if __name__ == '__main__':
    save_dir = r'/Users/zhaoyafei/Downloads/3D_model_assets/baked_skeleton_animations_retargeted_from_mixamo/'
    save_filename = r'tang_hik_hiphopdancing_skeleton_only6.fbx'

...
def make_blendshape_keys_settable(blendshape_node_name, blendshape_keys_list=None):
    ...
    Returns: list of dict
        Restore info of all the modifications to make blendshape settable.
    """
    ...
    return settable_restore_info_list


def restore_settable_modification(settable_restore_info_list):
    """
    ...
    Args:
        settable_restore_info_list: list of dict
            Restore info of all the modifications to make blendshape settable.
...
def export_blendshape_target_shapes(blendshape_node_name,
    ...
    if input_words == 'yes' or input_words == 'y':
        restore_info = make_blendshape_keys_settable(
            blendshape_node_name, blendshape_keys_list)
        need_restore = True
